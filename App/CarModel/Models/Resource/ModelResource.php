...
namespace App\CarModel\Models\Resource;

use App\Brand\Models\Selection\BrandSelection;
use App\CarLine\Models\Selection\LineSelection;
...
class ModelResource extends AbstractResource
{
    ...
    private function splitByModel(array $data): array
    {
        ...
        $model = $this->prepareValueSimpleMap(
            $data['data'],
            'App\CarModel\Models\Model'
        );
